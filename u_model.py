...
def _shortcut(_input, residual):
    ...
    if stride_width > 1 or stride_height > 1 or not equal_channels:
        ...
        shortcut = Conv2D(nb_filter=residual._keras_shape[1], nb_row=1, nb_col=1,
                                 subsample=(stride_width, stride_height),
                                 padding="valid", kernel_initializer="he_normal")(_input)
...
def inception_block(inputs, depth, batch_mode=0, splitted=False, activation='relu'):
    ...
    c1_1 = Conv2D(depth//4, (1, 1), padding="same", kernel_initializer="he_normal", data_format='channels_first')(inputs)
    print(c1_1.shape)
    # c2_1 = Convolution2D(depth//8*3, 1, 1, init='he_normal', border_mode='same')(inputs)
    c2_1 = Conv2D(depth//8*3, (1, 1), padding="same", kernel_initializer="he_normal", data_format='channels_first')(inputs)
    print(c2_1.shape)

    c2_1 = actv()(c2_1)
    if splitted:
        # c2_2 = Convolution2D(depth//2, 1, 3, init='he_normal', border_mode='same')(c2_1)
        c2_2 = Conv2D(depth//2, (1, 3), padding="same", kernel_initializer="he_normal", data_format='channels_first')(c2_1)
        ...
        c2_3 = Conv2D(depth//2, (3, 1), padding="same", kernel_initializer="he_normal", data_format='channels_first')(c2_2)

    else:
        # c2_3 = Convolution2D(depth//2, 3, 3, init='he_normal', border_mode='same')(c2_1)
        c2_3 = Conv2D(depth//2, (3, 3), padding="same", kernel_initializer="he_normal", data_format='channels_first')(c2_1)

    
    # c3_1 = Convolution2D(depth//16, 1, 1, init='he_normal', border_mode='same')(inputs)
    c3_1 = Conv2D(depth//16, (1, 1), padding="same", kernel_initializer="he_normal", data_format='channels_first')(inputs)

    #missed batch norm
    c3_1 = actv()(c3_1)
    if splitted:
        # c3_2 = Convolution2D(depth//8, 1, 5, init='he_normal', border_mode='same')(c3_1)
        c3_2 = Conv2D(depth//8, (1, 5), padding="same", kernel_initializer="he_normal", data_format='channels_first')(c3_1)
        ...
        c3_3 = Conv2D(depth//8, (5, 1), padding="same", kernel_initializer="he_normal", data_format='channels_first')(c3_2)

    else:
        # c3_3 = Convolution2D(depth//8, 5, 5, init='he_normal', border_mode='same')(c3_1)
        c3_3 = Conv2D(depth//8, (5, 5), padding="same", kernel_initializer="he_normal", data_format='channels_first')(c3_1)
    ...
    c4_2 = Conv2D(depth//8, (1, 1), padding="same", kernel_initializer="he_normal", data_format='channels_first')(p4_1)
...
def rblock(inputs, num, depth, scale=0.1):    
    ...
    residual = Conv2D(depth, (num, num), padding="same", data_format='channels_first')(inputs)
...
def NConvolution2D(nb_filter, nb_row, nb_col, border_mode='same', subsample=(1, 1)):
    def f(_input):
        ...
        conv = Conv2D(nb_filter=nb_filter, nb_row=nb_row, nb_col=nb_col, subsample=subsample
                            , padding=border_mode, kernel_initializer="he_normal", data_format='channels_first')(_input)
...
def reduction_a(inputs, k=64, l=64, m=96, n=96):
    ...
    c2_2 = Conv2D(n, (3, 3), subsample=(2,2), padding="same", kernel_initializer="he_normal", data_format='channels_first')(inputs_norm)
    ...
    conv3_2 = Conv2D(m, (3, 3), subsample=(2,2), padding="same", kernel_initializer="he_normal", data_format='channels_first')(conv3_2)
...
#     res = concatenate([pool1, conv2_2, conv3_2, conv4_3])
...
def get_unet_inception_2head(optimizer):
    ...
    pre = Conv2D(1, (1, 1), activation='sigmoid', kernel_initializer="he_normal", data_format='channels_first')(conv5)
    ...
    conv5_up = Conv2DTranspose(256, (2, 2), strides=(2, 2), padding='same', data_format='channels_first')(conv5)
    print(after_conv4.shape, conv5.shape, conv5_up.shape)
    print(inputs,conv1,pool1,conv2,pool2,conv3,pool3,conv4,pool4,conv5)

    up6 = concatenate([conv5_up, after_conv4], axis=1)
    ...
    conv6_up = Conv2DTranspose(128, (2, 2), strides=(2, 2), padding='same', data_format='channels_first')(conv6)
    up7 = concatenate([conv6_up, after_conv3], axis=1)
    ...
    conv7_up = Conv2DTranspose(64, (2, 2), strides=(2, 2), padding='same', data_format='channels_first')(conv7)
    up8 = concatenate([conv7_up, after_conv2], axis=1)
    ...
    conv5_up = Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same', data_format='channels_first')(conv8)
    up9 = concatenate([conv5_up, after_conv1], axis=1)
    ...
    conv10 = Conv2D(1, (1, 1), activation='sigmoid', name='main_output', 
                        kernel_initializer="he_normal", data_format='channels_first')(conv9)

    #print conv10._keras_shape

    print(inputs,conv1,pool1,conv2,pool2,conv3,pool3,conv4,pool4,conv5,up6,conv6,up7,conv7,up8,conv8,up9,conv9,conv10)
